...
export function HomePage({ locale = "ko" }: { locale?: Locale }) {
  ...
  const faqPreview = [
    {
      q: t("패션 브랜드 셀럽 협찬은 어떻게 진행되나요?"),
      a: t("셀럽 협찬은 상담·브랜드 검토 → PR 플랜 제안 → 계약 및 쇼룸 입점 → 스타일리스트 피칭 → 셀럽 착용 → 노출 클리핑 순으로 진행됩니다. 클라모아는 브랜드 무드에 맞는 셀럽과 채널을 매칭하고, 착용 이후 콘텐츠 클리핑과 2차 확산까지 단계별로 관리합니다."),
    },
    {
      q: t("신생 브랜드도 셀럽 협찬이 가능한가요?"),
      a: t("신생 브랜드도 가능합니다. 다만 제품 완성도, 브랜드 무드, 타깃 적합성이 성과를 좌우합니다. 클라모아는 브랜드 단계에 맞춰 PR 방향성을 먼저 설계하고, 무작위 노출이 아닌 타깃 중심의 셀럽 협찬으로 신생 브랜드의 인지도 확보를 돕습니다."),
    },
    {
      q: t("협찬 후 셀럽 착용이 보장되나요?"),
      a: t("착용 방식은 보장형과 비보장형으로 구분됩니다. 비보장형은 스타일리스트 피칭을 통한 자연스러운 착용을 지향하고, 보장형은 셀럽 초상권 단기 계약 등으로 노출을 확정합니다. 브랜드 목표와 예산에 맞춰 적합한 구조를 상담 단계에서 함께 정합니다."),
    },
    {
      q: t("셀럽 협찬 비용은 어떻게 책정되나요?"),
      a: t("협찬 비용은 브랜드 목표, 서비스 범위, 진행 기간, 콘텐츠 활용 범위에 따라 달라집니다. 셀럽 초상권 단기 계약처럼 2차 활용이 포함되면 비용 구조가 달라집니다. 정확한 견적은 상담 시 브랜드 상황과 캠페인 목표를 검토한 뒤 제안드립니다."),
    },
    {
      q: t("상담은 어떻게 신청하나요?"),
      a: t("홈페이지 문의 폼에 브랜드명, 제품 카테고리, 희망 서비스, 캠페인 목표, 예산 범위, 진행 시기를 남겨주시면 담당자가 빠르게 연락드립니다. 정보가 구체적일수록 브랜드에 맞는 PR 방향과 채널을 더 정확하게 제안드릴 수 있습니다."),
    },
  ];

  const process = [
    ["01", t("상담 접수"), t("브랜드 상황과 캠페인 목표를 남겨주시면 담당자가 빠르게 연락드립니다.")],
    [
      "02",
      t("브랜드 및 제품 검토"),
      t("브랜드 카테고리, 셀럽 타겟, 구매 연령층, 스큐 및 시즌 전략을 함께 검토합니다."),
    ],
    [
      "03",
      t("PR 플랜 제안"),
      t("예산과 목표에 맞춰 셀럽 협찬, PPL, 인플루언서, 셀럽 초상권 단기 계약 등 PR 플랜을 제안합니다."),
    ],
    [
      "04",
      t("계약 및 쇼룸 입점"),
      t("계약 완료 후 담당팀이 배정되며, 쇼룸 입점과 협찬 운영 세팅을 시작합니다."),
    ],
    [
      "05",
      t("스타일리스트 피칭 및\u00a0\n셀럽 협찬"),
      t("브랜드 타겟과 무드에 맞는 셀럽 및 스타일리스트 팀을 대상으로 룩북을 전달하고, 쇼룸 방문 시 제품 소개와 피칭을 진행합니다."),
    ],
    [
      "06",
      t("주간 보고 및 착용 자료 클립핑"),
      t("노출 콘텐츠를 클리핑하여 자사 SNS에 게시하고, 셀럽 픽업 및 착용 현황을 주간 보고합니다."),
    ],
    [
      "07",
      t("별도 콘텐츠 2차 확산"),
      t("이슈 가능한 소재를 기반으로 블로그, 매거진, 인플루언서 시딩 등 바이럴 확산을 진행합니다. (OPTION)"),
    ],
  ];

  const differentiators = [
    t("브랜드 단계에 맞춘 PR 방향성 설계"),
    t("무작위가 아닌 타겟 셀럽 협찬"),
    t("RINK 기반 운영 데이터 관리"),
    t("기획사 네트워크 기반 캠페인 연결"),
    t("팝업·플리마켓 등 오프라인 연계"),
    t("국내외 브랜드 글로벌 확장 지원"),
  ];
            ...
            <div className="col-span-12 md:col-span-8">
              ...
              <div className="max-w-xl space-y-6">
                ...
                <p className="text-body-md pl-6 max-w-lg whitespace-pre-line">
                  {
                    t("CLAMOA는 서울 압구정 기반의 패션 PR 에이전시로, 셀럽 협찬, 스타일리스트 릴레이션, PPL, 인플루언서 캠페인, 바이럴 콘텐츠, 글로벌 유통 확장을\u00a0\n통합적으로 설계합니다.")
                  }
                </p>
            ...
            <div className="col-span-12 md:col-span-10 md:col-start-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-20 reveal-group">
                {[
                  [
                    "METHOD",
                    t("브랜드 이미지에 맞는 셀럽과 채널을 매칭하고,\n노출 이후의 2차 활용까지 함께 설계합니다."),
                  ],
                  ["VISION", t("중요한 것은 많이 보이는 것이 아니라,\n브랜드답게 보이는 것입니다.")],
                  [
                    "RESULT",
                    t("브랜드의 무드가 소비자에게 자연스럽게 전달되고,\u00a0\n더 오래 기억되는 노출을 만듭니다."),
                  ],
                ].map(([h, b]) => (
                  <div
                    key={h}
                ...
                {[
                  {
                    country: "JAPAN",
                    kr: t("일본"),
                    desc: t("일본 주요 셀렉트샵 입점 연계를 비롯해 브랜드의 일본 시장 진출을 전략적으로 연결합니다."),
                  },
                  {
                    country: "TAIWAN",
                    kr: t("대만"),
                    desc: t("대만 주요 편집샵 입점 연계와 대만 왕홍 라이브 커머스 판매 연계를 지원합니다."),
                  },
                  {
                    country: "CHINA",
                    kr: t("중국"),
                    desc: t("셀럽 착용 자료를 기반으로 샤오홍수 바이럴, 중화권 유통 채널 확대, 왕홍 라이브커머스 판매 연계를 진행합니다."),
                  },
                ].map((m, i) => (
                  <div
                    key={m.country}
              ...
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  if (res.ok && data.ok) {
                    ...
                    if (submitBtn) submitBtn.textContent = t("SENT ✓ — 24시간 내 회신드리겠습니다");
                    form.reset();
                  } else {
                    if (submitBtn) {
                    ...
                    const msg =
                      data.error === "invalid_email"
                        ? t("이메일 주소를 올바르게 입력해 주세요.")
                        : data.error === "missing_fields"
                          ? t("이름 또는 브랜드명을 입력해 주세요.")
                          : t("전송에 실패했습니다. 잠시 후 다시 시도해 주세요.");
                    alert(msg);
                  }
                } catch {
                  if (submitBtn) {
            ...
            >
              {(
                [
                  ...
                  [t("Brand Name / 브랜드명"), "brand", "text", "col-span-2 md:col-span-1", false],
