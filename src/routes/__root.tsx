...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "클리모아는 쇼룸 전략, 셀러브리티 시딩, 스타일리스트 관계, 크리에이터 캠페인, 데이터 기반 PR로 패션·라이프스타일 브랜드의 문화적 가시성을 만들어내는 서울 기반 패션 PR 에이전시입니다." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&family=Noto+Serif:wght@400;700&family=Cormorant:wght@300;400&family=Noto+Serif+KR:wght@400;500;700&family=Noto+Sans+KR:wght@300;400;500;700&family=Material+Symbols+Outlined&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
