  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "인플루언서 PR(Influencer PR) — 패션 PR | CLAMOA" },
      {
        ...
        content:
          "패션 인플루언서 매칭과 캠페인 운영. 브랜드 무드에 맞는 큐레이션과 콘텐츠 설계.",
      },
      { property: "og:url", content: "https://clamoa.com/services/influencer-pr" },
    ],
    links: [
      { rel: "canonical", href: "https://clamoa.com/services/influencer-pr" },
    ],
  }),
  component: () => (
    <ServiceDetailPage
      ...
      steps={[
        { title: "인플루언서 큐레이션", desc: "브랜드 무드·타깃에 맞는 인플루언서 풀을 제안합니다." },
      ...
      faqs={[
        { q: "마이크로/메가 인플루언서 중 어느 쪽이 좋나요?", a: "캠페인 목적에 따라 다릅니다. 인지도는 메가, 전환은 마이크로·니치 인플루언서가 효과적일 수 있습니다." },
        { q: "콘텐츠 사용 권한은 어디까지인가요?", a: "기본 SNS 게시 + 브랜드 채널 재게시 권한을 협의하며, 광고 활용은 별도 옵션으로 진행합니다." },
        { q: "최소 캠페인 규모는?", a: "단일 시즌 캠페인 기준 5~10명 풀로 시작하는 것을 권장합니다." },
      ]}
    />
  ),
});
