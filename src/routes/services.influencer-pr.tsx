...
export const Route = createFileRoute("/services/influencer-pr")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://clamoa.com/services/influencer-pr" }, ...koServiceAlternates("influencer-pr")],
  }),
  component: () => (
    <ServiceDetailPage
      ...
      steps={[
        ...
        {
          title: "콘텐츠 발행 및 콘텐츠 체크·수정 요청",
          desc: "콘텐츠 발행 후 가이드라인 미준수 사항이나 수정이 필요한 부분을 확인해 보완 요청합니다.",
        },
        {
          title: "결과 리포트 제공",
          desc: "진행된 콘텐츠와 주요 노출 결과를 취합해 통합 리포트로 제공합니다.",
        },
      ]}
      deliverables={[
        "브랜드 타깃에 맞는 인플루언서 후보 리스트",
        "발행 콘텐츠 아카이브",
        "콘텐츠 가이드라인",
        "진행 결과 취합 및 통합 리포트 제공",
      ]}
      faqs={[
        {
