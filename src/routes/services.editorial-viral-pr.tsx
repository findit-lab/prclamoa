  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "에디토리얼·바이럴 PR — 패션 PR | CLAMOA" },
      {
        ...
        content:
          "매거진 화보, 디지털 에디토리얼, 바이럴 콘텐츠 기획·확산.",
      },
      { property: "og:url", content: "https://clamoa.com/services/editorial-viral-pr" },
    ],
    links: [
      { rel: "canonical", href: "https://clamoa.com/services/editorial-viral-pr" },
    ],
  }),
  component: () => (
    <ServiceDetailPage
      ...
      steps={[
        { title: "테마·매체 기획", desc: "시즌 무드와 매체 톤에 맞는 콘셉트와 매체 리스트를 설정합니다." },
        { title: "프로덕션", desc: "촬영팀·스타일링·로케이션을 구성하고 화보·콘텐츠를 제작합니다." },
      ...
      faqs={[
        { q: "광고 화보와 에디토리얼 화보의 차이는?", a: "광고는 브랜드 메시지 중심, 에디토리얼은 매체의 시즌 테마 안에서 브랜드를 풀어내는 형식입니다." },
        { q: "콘텐츠 사용 권한은?", a: "매체 정책에 따라 다르며, 보통 일정 기간 후 브랜드 채널 활용이 가능합니다." },
        { q: "바이럴은 어떤 식으로 설계하나요?", a: "에디토리얼 컷에서 SNS 친화 컷·릴스·숏폼을 함께 제작하여 다단 확산을 설계합니다." },
      ]}
    />
  ),
});
