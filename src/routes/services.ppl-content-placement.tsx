  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PPL & 콘텐츠 플레이스먼트 — 패션 PR | CLAMOA" },
      {
        ...
        content:
          "드라마·예능·MV·웹콘텐츠 PPL 매칭과 운영. 노출 효과 트래킹 포함.",
      },
      { property: "og:url", content: "https://clamoa.com/services/ppl-content-placement" },
    ],
    links: [
      { rel: "canonical", href: "https://clamoa.com/services/ppl-content-placement" },
    ],
  }),
  component: () => (
    <ServiceDetailPage
      ...
      steps={[
        { title: "작품·캐릭터 매칭", desc: "방영 일정·타깃·캐릭터 무드에 맞는 작품을 큐레이션합니다." },
      ...
      faqs={[
        { q: "PPL과 일반 협찬의 차이는?", a: "PPL은 작품 안에서 브랜드/제품이 의도적으로 노출되는 형태이고, 협찬은 캐릭터/출연자가 자연스럽게 착용·사용하는 형태입니다." },
        { q: "비용은 어떻게 책정되나요?", a: "작품 규모, 노출 회차, 사용 권한에 따라 달라집니다. 브리프 단계에서 예산 가이드를 제시합니다." },
        { q: "방영 후 콘텐츠를 활용할 수 있나요?", a: "제작사와 사전 협의된 범위 내에서 SNS·상세페이지 등에 활용할 수 있습니다." },
      ]}
    />
  ),
});
