  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://clamoa.com/process" },
      {
        name: "keywords",
        content:
          "패션 PR 대행 진행 방식, 셀럽 협찬 프로세스, 패션 PR 단계, 쇼룸 입점, 스타일리스트 피칭, 협찬 리포팅",
      },
    ],
...
const steps = [
  {
    id: "01",
    title: "상담 접수",
    desc: "문의 폼에 브랜드명, 제품 카테고리, 희망 서비스, 캠페인 목표, 예산 범위, 진행 시기를 남기면 담당자가 빠르게 연락합니다. 정보가 구체적일수록 더 정확한 제안이 가능합니다.",
    output: "1차 미팅 일정 · 사전 진단 노트",
  },
  {
    id: "02",
    title: "브랜드 · 제품 검토",
    desc: "브랜드 무드, 시즌 컨셉, 타깃 소비자, 가격대, 기존 PR 자산을 검토합니다. 룩북·샘플·SNS·쇼핑몰 링크를 기반으로 시장 내 포지셔닝과 PR 적합도를 진단합니다.",
    output: "포지셔닝 진단 · 적합 PR 채널 정리",
  },
  {
    id: "03",
    title: "PR 플랜 제안",
    desc: "셀럽 협찬·스타일리스트 릴레이션·PPL·인플루언서·바이럴·글로벌 중 브랜드 단계에 맞는 조합을 설계합니다. KPI, 일정, 예산 구조까지 함께 제시합니다.",
    output: "PR 플랜 덱 · 견적안 · 타임라인",
  },
  {
    id: "04",
    title: "계약 및 쇼룸 입점",
    desc: "서비스 범위와 기간을 계약으로 확정하고, 시즌 제품을 압구정 로데오 쇼룸에 입점합니다. 룩북·인벤토리·픽업 운영 환경을 세팅합니다.",
    output: "계약서 · 쇼룸 인벤토리 · 픽업 운영 셋업",
  },
  {
    id: "05",
    title: "스타일리스트 피칭",
    desc: "현역 스타일리스트와 어시스턴트 풀에 신상품 프리뷰와 룩북을 공유합니다. 픽업 가능 일정과 룩 조합을 조율해 자연스러운 착장 기회를 만듭니다.",
    output: "스타일리스트별 픽업 · 룩 매칭 기록",
  },
  {
    id: "06",
    title: "셀럽 협찬 및 클리핑",
    desc: "방송·공항·화보·SNS 등 채널에서 발생하는 셀럽 착용 노출을 모니터링하고, 노출 자료를 RINK 시스템에 적재합니다.",
    output: "착장 클리핑 아카이브 · 노출 채널별 데이터",
  },
  {
    id: "07",
    title: "주간 보고",
    desc: "셀럽 픽업·착용 현황, 노출 채널, 미디어 가치 환산, SNS 반응을 주간 단위로 보고합니다. 데이터를 기반으로 다음 주 운영 방향을 함께 결정합니다.",
    output: "주간 리포트 · 다음 주 액션 플랜",
  },
  {
    id: "08",
    title: "2차 확산 (옵션)",
    desc: "확보된 셀럽 착용 자료를 매거진·블로그·SNS 시딩, 상세페이지, 광고 소재, 일본·대만·중국 글로벌 채널로 확장합니다. 단순 노출이 아닌 자산화를 목표로 합니다.",
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 md:col-span-8">
              <p className="text-body-lg border-l-4 border-neon-signal pl-6">
                패션 PR 대행은 상담 접수부터 브랜드 검토, PR 플랜 제안, 쇼룸 입점, 스타일리스트
                피칭, 셀럽 협찬·클리핑, 주간 보고, 2차 확산까지 8단계로 진행됩니다. CLAMOA는 각
                단계에서 무엇을 운영하고 어떤 결과물을 전달하는지 투명하게 공개합니다.
              </p>
            </div>
          </div>
        </section>
